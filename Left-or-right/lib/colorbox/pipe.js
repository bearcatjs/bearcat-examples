...
function triggerEvent(ep, content)
{
  ...
  var imp = ep[_key]
  var e = make_event(content, imp.clocker.exec("now"))
  imp.current[_next] = e
  imp.current = e
...
function delayP(p, t, clocker)
{
  assert(isPipe(p) && clocker);
